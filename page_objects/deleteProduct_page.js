...
class DeleteProductPage {
    ...
    async waitForDeleteSuccessMessageAvailable() {
        await browser.wait(protractor.ExpectedConditions.visibilityOf(this.getDeleteSuccessMessage()), 15000);
    }
    ...
    async waitForDeleteBtnClickable() {
        await browser.wait(protractor.ExpectedConditions.elementToBeClickable(this.getDeleteBtn()), 15000);
    }
